...
public class Transacoes {
    ...
    public static String gerarQRcode(Conta conta, double valor){
        return conta.getIdConta() +";"
                ...
                +valor+";"+ getRandomNumberInRanger(1000, 9999);
    }
    ...
    public static String pagamentoQRcode(String QRcode, Conta conta){
        ...
        Conta contaDestino = ListaContas.getConta(
                (c)->{return  c.getIdConta() == id && c.getUsuario().getNome().equals(dados[1]);} // Busca conta de acordo com id e nome igual ao do qrCode
                );
